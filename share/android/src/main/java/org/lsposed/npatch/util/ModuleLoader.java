...
public class ModuleLoader {
    ...
    // NPatch 102 branch ships the libxposed/api 102.0.0 framework, so it can satisfy
    // modules that require up to API 102. Modules targeting API 100 are intentionally
    // rejected (this branch dropped API 100 support).
